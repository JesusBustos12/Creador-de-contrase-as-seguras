...
import path from "path"; // <--- CAMBIO 1: Importar path
...
// <--- CAMBIO 2: Configuración correcta de la carpeta estática para Vercel
...
// <--- CAMBIO 3: Ruta explícita para asegurar que cargue el index.html
app.get('/', (req, res) => {
    res.sendFile(path.join(process.cwd(), 'front-end', 'index.html'));
});
